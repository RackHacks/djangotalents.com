...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_userprofile', (
            ...
            ('looking_for_a_job', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', null=True, to=orm['countries.Country'])),
            ...
            ('gtalk', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('yahoo', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('aim', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('jabber', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('irc', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ...
        db.create_table('main_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='portfolio', to=orm['main.UserProfile'])),
